...
BOOST_FIXTURE_TEST_CASE(initial_sync_batch_window, TestChain100Setup)
{
    ...
    for (int round = 0; round < 2; round++) { // two rounds to test sync from genesis and from a higher block
        ...
        BlockFilterIndex filter_index(interfaces::MakeChain(m_node), BlockFilterType::BASIC, 1_MiB, /*f_memory=*/false);
